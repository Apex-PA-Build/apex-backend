-- ============================================================
-- APEX — Full Reset + Recreate
-- Run this in Supabase SQL Editor to wipe and rebuild everything
-- ============================================================

-- ── Drop trigger on auth.users first (system table always exists) ──
drop trigger if exists on_auth_user_created on auth.users;

-- ── Drop tables with CASCADE (also drops their triggers + policies) ──
...
-- ============================================================
-- VERIFY — run this last to confirm all 10 tables exist
-- ============================================================
select tablename
from pg_tables
